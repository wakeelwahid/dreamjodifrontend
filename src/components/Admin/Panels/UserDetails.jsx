    ...
    <div className="st-panel">
      ...
      <div className="st-user-details">
        ...
        <div className="st-detail-row st-highlight">
          <span className="st-detail-label">Total Cashback Earned:</span>
          <span className="st-detail-value">
            ₹
      ...
      <div className="st-section">
        <h3 className="st-section-title">Add Coins History</h3>
        ...
        <div className="st-total">
          <span className="st-total-label">Total Add Coins:</span>
      ...
      <div className="st-section">
        <h3 className="st-section-title">Redeem History</h3>
        <div className="st-table-container">
          <table className="st-data-table">
            <thead>
              <tr>
        ...
        <div className="st-total">
          <span className="st-total-label">Total Redeem:</span>
          <span className="st-total-value">
            ₹
            {withdrawals
      ...
      <div className="st-section">
        ...
        <h3 className="st-section-title">Entry History (Last 2 Months)</h3>
        <div className="st-table-container">
          <table className="st-data-table">
            <thead>
              <tr>
        ...
        <div className="st-game-totals">
          <h4 className="st-subtitle">Game-wise Entry Totals:</h4>
