...
const DepositRequestPanel = () => {
  ...
  const totalAmount = deposits.reduce(
    (sum, dep) => sum + parseFloat(dep.amount),
    0
  );
      ...
      {message && (
        <div
          style={{
            ...
            border: `1px solid ${
              message.type === "success" ? "#b2ffb2" : "#ffb2b2"
            }`,
            padding: 10,
            borderRadius: 6,
            textAlign: "center",
                      ...
                      {deposit.status === "pending" ? (
                        <div className="action-buttons">
                          <button
                            ...
                            onClick={() =>
                              handleActionClick(deposit, "approve")
                            }
                          >
                            ✓ Approve
                          </button>
              ...
              <div className="confirmation-message">
                ...
                {actionType === "approve" && (
                  <div className="approval-note">
                    ₹{selectedDeposit.amount} will be added to the user's
                    wallet.
                  </div>
                )}
              </div>
