    ...
    <>
      <div className="referral-card">
        ...
        <div className="benefits-section">
          ...
          <div className="benefits-grid">
            ...
            <div className="benefit-card">
              ...
              <h3 className="benefit-title">1% Lifetime Cashback</h3>
        ...
        <div className="code-section">
          ...
          <div className="share-buttons">
            ...
            <button
              ...
              onClick={() => {
                const message = `Join me on Dream Jodi using my referral code: ${
                ...
                if (navigator.share) {
                  navigator.share({
                    title: "Dream Jodi Referral",
                    text: message,
                    url: window.location.origin,
                  });
                } else {
                  // WhatsApp intent for mobile, fallback for desktop
                  const isMobile =
        ...
        <div className="commission-section">
          <h2 className="benefits-title">Cashback Structure</h2>
          <div className="commission-cards">
            ...
            <div className="commission-card">
              ...
              <p className="commission-desc">Lifetime cashback</p>
            </div>
          </div>
        </div>
      </div>
